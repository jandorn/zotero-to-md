...
def test_extract_web_text_sanitizes_null_bytes_before_readability(monkeypatch) -> None:
    monkeypatch.setattr("zotero_to_md.extract_web.trafilatura.fetch_url", lambda _url: "ab\x00c")
    monkeypatch.setattr("zotero_to_md.extract_web.trafilatura.extract", lambda *_args, **_kwargs: None)
